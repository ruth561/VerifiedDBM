...
fn down(d: &mut Vec<Vec<i64>>, n: usize) {
    ...
    lem_for_down_011(&d, &d_old, n); // i==0 && j!=0 && k!=0
    lem_for_down_001(&d, &d_old, n); // i==0 && j==0 && k!=0
    lem_for_down_010(&d, &d_old, n); // i==0 && j!=0 && k==0
    lem_for_down_000(&d, &d_old, n); // i==0 && j==0 && k==0
